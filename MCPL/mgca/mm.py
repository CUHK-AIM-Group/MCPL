...
class MGCA(LightningModule):
    ...
    def __init__(self,
        ...
        # self.patch_local_atten_layer = nn.MultiheadAttention(self.hparams.emb_dim, self.hparams.num_heads, batch_first=True)
        self.patch_local_atten_layer = nn.MultiheadAttention(self.hparams.emb_dim, self.hparams.num_heads)
        # sentence local attention layer
        # self.word_local_atten_layer = nn.MultiheadAttention(self.hparams.emb_dim, self.hparams.num_heads, batch_first=True)
        self.word_local_atten_layer = nn.MultiheadAttention(self.hparams.emb_dim, self.hparams.num_heads)
...
def cli_main():
    ...
    ckpt_dir = os.path.join(BASE_DIR, f"D:/123/MGCA-main/data/ckpts/MGCA/{extension}")
    ...
    logger_dir = os.path.join(BASE_DIR, f"D:/123/MGCA-main/data")
